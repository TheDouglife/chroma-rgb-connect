...
using ChromaConnect.SDK.OpenRGB.Internal.Windows;
...
internal sealed partial class OpenRGBManager : IDisposable
{
    ...
    public void Stop()
    {
        ...
        var processes = Process.GetProcessesByName("ChromaConnect.OpenRGB");
    ...
    private static string FindExecutablePath()
    {
        ...
        {
            Path.Combine(assemblyPath, "ChromaConnect.OpenRGB.exe"),
            Path.Combine(assemblyPath, "runtimes", runtimeIdentifier, "native", "ChromaConnect.OpenRGB.exe")
        };
