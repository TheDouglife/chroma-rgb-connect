...
public class ServiceMonitorPathSelectionTests
{
    ...
    {
        var result = ServiceMonitor.SelectMatchingCandidateIndex("C:/Apps/ChromaConnect.Service.exe", []);
    ...
    public void SelectMatchingCandidateIndexReturnsMatchingIndexCaseInsensitive()
    {
        var candidates = new[]
        {
            ...
            new ProcessPathCandidate(1, "c:/apps/chromaconnect.service.exe")
        };

        var result = ServiceMonitor.SelectMatchingCandidateIndex("C:/Apps/ChromaConnect.Service.exe", candidates);
    ...
    public void SelectMatchingCandidateIndexSkipsEmptyAndInvalidPaths()
    {
        var candidates = new[]
        {
            ...
            new ProcessPathCandidate(3, "C:/Apps/ChromaConnect.Service.exe")
        };
